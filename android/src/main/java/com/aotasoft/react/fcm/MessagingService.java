...
import com.aotasoft.react.twilio.CallNotificationManager;
import com.aotasoft.react.twilio.SoundPoolManager;
...
import static com.aotasoft.react.twilio.TwilioVoiceModule.ACTION_INCOMING_CALL;
import static com.aotasoft.react.twilio.TwilioVoiceModule.INCOMING_CALL_INVITE;
import static com.aotasoft.react.twilio.TwilioVoiceModule.INCOMING_CALL_NOTIFICATION_ID;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Intent i = new Intent("com.aotasoft.react.fcm.ReceiveNotification");
        ...
        handleMessageTwilio(remoteMessage);
    }
    ...
    private void handleMessageTwilio(RemoteMessage remoteMessage) {
                    ...
                    handler.post(new Runnable() {
                        public void run() {
                            ...
                            if (context != null) {
                                ...
                                MessagingService.this.handleIncomingCall((ReactApplicationContext) context, notificationId, callInvite, launchIntent);
                            } else {
