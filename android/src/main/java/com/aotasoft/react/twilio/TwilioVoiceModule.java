...
public class TwilioVoiceModule extends ReactContextBaseJavaModule implements ActivityEventListener, LifecycleEventListener {
    ...
    public static final String ACTION_INCOMING_CALL = "com.aotasoft.react.TwilioVoice.INCOMING_CALL";
    public static final String ACTION_FCM_TOKEN     = "com.aotasoft.react.fcm.FCMRefreshToken";
    public static final String ACTION_MISSED_CALL   = "com.aotasoft.react.TwilioVoice.MISSED_CALL";
    public static final String ACTION_ANSWER_CALL   = "com.aotasoft.react.TwilioVoice.ANSWER_CALL";
    public static final String ACTION_REJECT_CALL   = "com.aotasoft.react.TwilioVoice.REJECT_CALL";
    public static final String ACTION_HANGUP_CALL   = "com.aotasoft.react.TwilioVoice.HANGUP_CALL";
    public static final String ACTION_CLEAR_MISSED_CALLS_COUNT = "com.aotasoft.react.TwilioVoice.CLEAR_MISSED_CALLS_COUNT";
    ...
    public static final String PREFERENCE_KEY = "com.aotasoft.react.TwilioVoice.PREFERENCE_FILE_KEY";
    ...
    private RegistrationListener registrationListener() {
        return new RegistrationListener() {
            ...
            public void onRegistered(String accessToken, String fcmToken) {
                ...
                eventManager.sendEvent(EventManager.EVENT_DEVICE_READY, null);
            }
            ...
            public void onError(RegistrationException error, String accessToken, String fcmToken) {
                ...
                eventManager.sendEvent(EventManager.EVENT_DEVICE_NOT_READY, params);
            }
        };
    }
    ...
    private Call.Listener callListener() {
        return new Call.Listener() {
            ...
            public void onConnected(Call call) {
                ...
                eventManager.sendEvent(EventManager.EVENT_CONNECTION_DID_CONNECT, params);
            }
            ...
            public void onDisconnected(Call call, CallException error) {
                ...
                eventManager.sendEvent(EventManager.EVENT_CONNECTION_DID_DISCONNECT, params);
            ...
            if (intent.getAction().equals(ACTION_INCOMING_CALL)) {
                ...
                if (activeCallInvite != null && (activeCallInvite.getState() == CallInvite.State.PENDING)) {
                    ...
                    if (appImportance == RunningAppProcessInfo.IMPORTANCE_FOREGROUND ||
                        ...
                        eventManager.sendEvent(EventManager.EVENT_DEVICE_DID_RECEIVE_INCOMING, params);
                    }
...
//        activeCallInvite = null;
    ...
    public void accept() {
        ...
        if (activeCallInvite != null){
            ...
            eventManager.sendEvent(EventManager.EVENT_CONNECTION_DID_DISCONNECT, null);
        }
    }
    ...
    public void connect(ReadableMap params) {
        ...
        if (accessToken == null) {
            ...
            eventManager.sendEvent(EventManager.EVENT_DEVICE_NOT_READY, errParams);
            return;
        }
        if (params == null) {
            errParams.putString("err", "Invalid parameters");
            eventManager.sendEvent(EventManager.EVENT_CONNECTION_DID_DISCONNECT, errParams);
            return;
